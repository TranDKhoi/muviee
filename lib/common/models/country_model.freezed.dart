...
abstract class $CountryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, String? code, String? image});
}
...
class _$_CountryModel implements _CountryModel {
  const _$_CountryModel({this.id, this.name, this.code, this.image});
  ...
  @override
  String toString() {
    return 'CountryModel(id: $id, name: $name, code: $code, image: $image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, code, image);
...
abstract class _CountryModel implements CountryModel {
  const factory _CountryModel(
      ...
      final String? name,
      final String? code,
      final String? image}) = _$_CountryModel;
